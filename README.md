...
| Rörelse | Gångfart och acceleration, markfäste, hur mycket fart som följer med i landningen och i hoppet, studs mot väggar, knuffkraft, benens fjädring, spelrum och släng i luften, om de förbereder landningen, hur högt hinder han kliver över, klivets takt, hur länge han streter innan han vänder, högsta fart och kamerans släp |
...
Fem banor, valbara i panelen under *Bana* (eller med F3). **Klättringen ligger först**,
för den är den enda som är en bana och inte en verkstad: den som öppnar spelet utan att
veta något ska möta något att klara. De fyra andra är verkstäder där enskilda mekaniker
provas. I alla är marken sammanhängande hela vägen — RB går av sig själv, och en bana
där auto-gången kan leda ner i en avgrund straffar spelaren för att inte trycka.
...
strid lade en mur framför honom. Nu lyfter benen honom upp på det som är lågt nog.
Gränsen är ett reglage (*Rörelse* → *Kliver över hinder upp till*, grund 26 px) och
ligger med flit mellan skräpet (17–20 px) och en hel låda (40 px). Rullande gäller
bollens egen gräns i stället: han tar en kant som är lägre än radien, och bara om farten
räcker (v² = v0² − 2·g·h) — han betalar alltså klivet i fart, medan benen inte har någon
sådan gräns.

**Och han vänder inte för att något nuddar honom.** Förut vände han i samma bildruta som
benen rörde vid vad som helst; nu går han emot det en stund (grund 0,35 s, reglage under
*Rörelse*). Under tiden hinner han kliva upp på det, eller knuffa undan det — en hel låda
