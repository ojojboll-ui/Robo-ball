...
| 7 | 2026-09 | **Förmågor i v1: rulla, ben, spikar, ficklampan.** | Täcker horisontell, vertikal och "utanför golvet"-rörelse plus en synlig ljusgrind. Hårt skal, kroken, gummiskal och turbon skjuts till v2. Förstörbar fysik finns ändå från start — skalet höjer bara tröskeln, det skapar den inte. | Beslutat |
